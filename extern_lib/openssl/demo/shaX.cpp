...
//编译: 散列算法(签名算法)(哈系算法)
//g++ -ggdb3 -o sha_all_test shaX.cpp -lcrypto
...
/*
	...
	sha系列校验算法的作用, 基本只能保证数据完整性,
	保证数据没有被篡改过, 而不是对数据进行加密!!
	...
	只需对比出‘数据传输前’,和‘传输后’计算出来的sha校验码是否一致,
	即可知道数据是否被篡改.

	为了防止校验码被篡改, 从而数据可能被改写,
	你可以对'sha校验码'进行加密!!
*/
