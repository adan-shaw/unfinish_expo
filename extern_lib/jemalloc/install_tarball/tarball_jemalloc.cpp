...
//编译:
//g++ -ggdb3 -o x ./tarball_jemalloc.cpp \
-Bdynamic -ljemalloc -DJEMALLOC_NO_DEMANGLE



//1.安装jemalloc
/*
	解压jemalloc-stable-3.tar.gz 到/home/adan/Public
	./autogen.sh
	./configure
	make
	make install

	你可能需要修改一下: Makefile_in [目前已经改好了]
	install: install_bin install_include install_lib "install_doc"->删除
	直接删除"install_doc"即可
*/
...
//3.安装玩之后测测试代码, 查看jemalloc 是否正确安装.
//	还要调用ldd ./x 查看是否有jemalloc 链接库, 才算安装成功
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
